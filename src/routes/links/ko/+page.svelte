...
<svelte:head>
	...
	<!-- Facebook Meta Tags -->
	<meta property="og:url" content="https://eunjae.dev/links/ko" />
	...
	<meta property="twitter:url" content="https://eunjae.dev/links/ko" />
...
<style>
	li a {
		@apply flex items-center gap-2 underline underline-offset-4 opacity-75 hover:opacity-100;
	}
</style>
